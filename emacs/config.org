...
*** Company
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package company
        ...
        ;; Have suggestions start after two characters have been typed, not three
...
*** Smartparens
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package smartparens
        :config
        ;; By default, smartparens adds this sort of annoying background highlighting
      ...
      If `NAME' is provided, it will be used in place of `SEQUENCE' in the function name that's generated."
        ...
        ;; Some good ides to use with this one, but should go in their respective
        ;; language section:
        ;; c++-mode
        ;; c-mode
        ;; css-mode
